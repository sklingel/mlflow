...
@cli_args.AUTH_TOKEN
def serve(model_uri, port, host, workers, no_conda=False, install_mlflow=False, auth_token=None):
    """
    ...
    ).serve(model_uri=model_uri, port=port, host=host, auth_token=auth_token)
